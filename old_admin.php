<?php
    echo exec("cat /var/log/pihole.log | awk '/\/etc\/pihole\/gravity.list/ && !/address/ {print $6}' | wc -l");
?>
joe@raspi-dns:/var/www/html/admin $ cd ..
joe@raspi-dns:/var/www/html $ cat admin/index.php 
<?php
